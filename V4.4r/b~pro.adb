pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~pro.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~pro.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_pro");
...
--  BEGIN Object file/option list
   --   ./pro.o
   --   -L./
   --   -L/project/Ada/GNAT/2015/lib/gcc/x86_64-apple-darwin13.4.0/4.9.3/adalib/
   --   -static
   --   -lgnarl
   --   -lgnat

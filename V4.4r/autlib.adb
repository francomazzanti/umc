...
--      Put_line (" ranksep=0.2;  ");  --  ADDED 20-09-2010  removed 05-02-2017
      ...
      -- C1 generated by dotgen -a, W1 generated by mc2dot -t, W0 generated by aut2dot
      ...
      Put_Line (Initial & " [style=bold,peripheries=2];");
...
--       Put_Line (nick & " [label=""" & Splitted(Dot_Fix(Adjust(labels))) & """];");
   ...
   begin
     ...
     if Encode_State_Labels and Remove_Tau_Transitions then
       ...
       Put_Line ( " " & nick & " -> " &  "x" & nick & ";");
       Put_Line ("x" & nick & 
--   " [peripheries=2,shape=triangle,color=red,style=filled,comment="""",label="""", " &
--   " [width=1.8,height=1.8,shape=polygon,sides=3,peripheries=2,color=red,fillcolor=red,style=filled,comment="""",label="""", " &
   ...
   ----------------------------------------------------------------------------
   -- called only when Remove_Tau_Transitions=True
   ----------------------------------------------------------------------------

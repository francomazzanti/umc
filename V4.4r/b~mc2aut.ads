...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mc2aut" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#efaa0bac#;
   pragma Export (C, u00001, "mc2autB");
   ...
   u00205 : constant Version_32 := 16#626a9f0c#;
   pragma Export (C, u00205, "system__direct_ioB");
   u00206 : constant Version_32 := 16#6149cc99#;
   pragma Export (C, u00206, "system__direct_ioS");
